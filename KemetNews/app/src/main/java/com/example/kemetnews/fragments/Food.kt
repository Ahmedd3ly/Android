...
class Food : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.food_fragment, null)
        val recyclerView = view?.findViewById<RecyclerView>(R.id.recycler_food)
        articles = ArrayList()
    ...
    private fun showNews() {
        ...
        apiRequest.getCategoryNews(
            ...
            this.requireContext().getString(R.string.Language), this.requireContext().getString(R.string.Food)
        )
