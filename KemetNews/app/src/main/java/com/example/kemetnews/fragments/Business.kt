...
class Business : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.business_fragment, null)
        val recyclerView = view?.findViewById<RecyclerView>(R.id.recycler_business)
        articles = ArrayList()
    ...
    private fun showNews() {
        ...
        apiRequest.getCategoryNews(
            ...
            this.requireContext().getString(R.string.Language), this.requireContext().getString(R.string.Business)
        )
