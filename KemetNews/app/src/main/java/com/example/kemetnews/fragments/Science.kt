...
class Science : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view?.findViewById<RecyclerView>(R.id.recycler_science)
        articles = ArrayList()
    ...
    private fun showNews() {
        ...
        apiRequest.getCategoryNews(
            ...
            this.requireContext().getString(R.string.Language), this.requireContext().getString(R.string.Science)
        )
