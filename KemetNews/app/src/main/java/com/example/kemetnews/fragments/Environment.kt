...
class Environment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.environment_fragment, null)
        val recyclerView = view?.findViewById<RecyclerView>(R.id.recycler_environment)
        articles = ArrayList()
    ...
    private fun showNews() {
        ...
        apiRequest.getCategoryNews(
            ...
            this.requireContext().getString(R.string.Language), this.requireContext().getString(R.string.Environment)
        )
