...
class Sports : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view?.findViewById<RecyclerView>(R.id.recycler_sports)
        articles = ArrayList()
    ...
    private fun showNews() {
        ...
        apiRequest.getCategoryNews(
            ...
            this.requireContext().getString(R.string.Language), this.requireContext().getString(R.string.Sports)
        )
